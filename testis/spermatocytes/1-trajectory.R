...
setwd(rprojroot::find_root())
setwd('testis/spermatocytes/')
...
# the late spermatocytes are really acting weird, with tons of unexplored heterogeneity and very low expression
# this "masks" the main trajectory that you can see e.g. the PCA
# we therefore manually adapt the clustering of these late spermatocytes
seu_oi$annotation[seu_oi$seurat_clusters %in% c(1, 2, 4)] = "late primary spermatocytes"
